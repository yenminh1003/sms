...
<div class="col-md-12">
  <div class="panel panel-default">
  	...
  	<div class="panel-body">
  	    ...
  	    <div class="form-horizontal">
  	    	<div class="form-group">
  	    		<label for="type" class="col-sm-2 control-label">Kiểu</label>
  	    		<div class="col-sm-10">
  	    			<select class="form-control" id="type">
  	    				<option value="">Lựa chọn đối tượng</option>
  	    				<option value="1">Cá nhân</option>
  	    				<option value="2">Số lượng lớn</option>
  	    			</select>
  	    		</div>
  	    	</div>
  	    </div>
      ...
      <div class="pull pull-right">
        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#add-expenses-modal" onclick="addExpenses()">Thêm học phí</button>        
      </div>
...
Tổng số mặt hàng</th>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="well">
            <h5>Ngân sách hiện tại : <span class="badge"><?php echo $totalBudget; ?></span></h5>
          </div>
        </div>
        
        <div class="col-md-8">
          <div class="well">
            <h5>Tổng tiền thanh toán : <span class="badge"><?php echo $totalIncome; ?></span></h5>
            <h5>
Tổng học phí : <span class="badge"><?php echo $totalExpenses; ?></span></h5>
          </div>
        </div>
      </div>
...
Quản lý bộ phận
		...
		<div class="list-group">
		  	<a type="button" class="list-group-item" id="managePaymentInfo">Quản lý thanh toán</a>
		  	<a type="button" class="list-group-item" id="manageStudentPayInfo">
Quản lý thanh toán của sinh viên</a>
		</div>
	</div>
</div><!-- /.col-sm-3 -->
<div class="col-sm-9">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      	<div class="modal-header">
        	...
        	<h4 class="modal-title">Chỉnh sửa thanh toán</h4>
      	</div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removePayment">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Xóa thanh toán</h4>
      </div>
      <div class="modal-body">
        <p>
Bạn có thực sự muốn loại bỏ ? </p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        <button type="button" class="btn btn-primary" id="removePaymentBtn">
Lưu thay đổi</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="editStudentPay">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      	<div class="modal-header">
        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        	<h4 class="modal-title">Chỉnh sửa khoản thanh toán của sinh viên</h4>
      	</div>
...
Bạn có thực sự muốn loại bỏ? </p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        <button type="button" class="btn btn-primary" id="removeStudentPayBtn">
Lưu thay đổi</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
...
Thêm học phí</h4>
      ...
      <div class="modal-body" style="height: 500px;overflow-y: scroll;">
        ...
        <div class="form-group">
          <label for="expensesDate" class="col-sm-3 control-label">Ngày nộp học phí:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="expensesDate" name="expensesDate" placeholder="Expenses Date" />
          </div>
        </div>
        <div class="form-group">
          <label for="expensesName" class="col-sm-3 control-label">Tên học phí:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" id="expensesName" name="expensesName" placeholder="Expenses Name" />
          </div>
        </div>
        <div class="form-group">
          <label for="totalAmount" class="col-sm-3 control-label">Tổng cộng:</label>
          <div class="col-sm-9">
...
Số tiền</th>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        <button type="button" class="btn btn-default" onclick="addExpensesRow()">Thêm dòng</button>
        <button type="submit" class="btn btn-primary" id="createExpensesBtn">
Lưu thay đổi</button>      
      </div>      
...
Chỉnh sửa học phí</h4>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        <button type="button" class="btn btn-default" onclick="addEditExpensesRow()">Thêm dòng</button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeExpensesModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Xóa học phí</h4>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        <button type="button" class="btn btn-primary" id="removeExpensesBtn">Lưu thay đổi</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="viewIncomeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Thông tin thu nhập</h4>
      </div>
      <div class="modal-body">
